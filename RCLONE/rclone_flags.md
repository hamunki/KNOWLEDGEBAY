...
Global Flags:
      ...
      --cache-dir string                     Directory rclone will use for caching. (default "/home/goatfarm/.cache/rclone")
  ...
  -c, --checksum                             Skip based on checksum (if available) & size, not mod-time & size
      ...
      --config string                        Config file. (default "/home/goatfarm/.config/rclone/rclone.conf")
  ...
  -u, --update                               Skip files that are newer on the destination.
      ...
      --user-agent string                    Set the user-agent to a specified string. The default is rclone/ version (default "rclone/v1.53.3-DEV")
...
Backend Flags:
      ...
      --cache-chunk-path string                      Directory to cache chunk files. (default "/home/goatfarm/.cache/rclone/cache-backend")
      ...
      --cache-db-path string                         Directory to store file structure metadata DB. (default "/home/goatfarm/.cache/rclone/cache-backend")
  ...
  -L, --copy-links                                   Follow symlinks and copy the pointed to item.
      ...
      --ftp-user string                              FTP username, leave blank for current username, goatfarm
  ...
  -x, --one-file-system                              Don't cross filesystem boundaries (unix/macOS only).
      ...
      --sftp-user string                             SSH username, leave blank for current username, goatfarm
